...
describe("BigSlot", () => {
    it("DayTimeMatrix should have length of 7 * 14 (case 1)", () => {
        ...
        const result = new bigSlot_1.BigSlot(slot);
    ...
    it("check for intersection 1", () => {
        ...
        y.SubjectName = "XXX";
        y.Type = "T";
        const slot1 = new bigSlot_1.BigSlot(slot_1.CreateSlotFromRaw(x));
        const slot2 = new bigSlot_1.BigSlot(slot_1.CreateSlotFromRaw(y));
