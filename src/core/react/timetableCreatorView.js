...
class TimetableCreatorView extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", null,
            React.createElement(leftRightPanel_1.LeftRightPanel, null,
                React.createElement(Button_1.default, { style: selectSubjectButtonStyle, variant: "contained", color: "secondary", onClick: this.props.handleOpenSubjectListView },
                    React.createElement(List_1.default, { style: styles_1.iconStyle }),
                    "Select subjects"),
                React.createElement("div", { style: Object.assign({}, switchStyle) },
                    React.createElement(stackPanel_1.StackPanel, { horizontalAlignment: "right", orientation: "horizontal" },
