...
class TimetableView extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { id: "timetable-view" },
            " ",
            ...
            React.createElement(stackPanel_1.StackPanel, { orientation: "vertical", horizontalAlignment: "center" },
                React.createElement("div", { style: divStyle },
                    ...
                    this.props.slots.length > 0 ?
                        ...
                        : null),
                React.createElement("div", { style: { display: this.props.isSummaryOpen ? "inline" : "none" } },
                    React.createElement(timetableSummaryView_1.TimetableSummaryView, { slots: this.props.slots })))));
    }
    componentDidMount() {
