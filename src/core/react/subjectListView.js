...
class SubjectListView extends React.Component {
    constructor(props) {
        super(props);
        this.handleSearchBoxOnChange = () => {
            const searchedText = document.getElementById("searchbar").value;
    ...
    render() {
        ...
        return (React.createElement("div", null,
            React.createElement(Drawer_1.default, { elevation: 16, open: this.props.IsOpen, onClose: this.handleClose },
                React.createElement("section", { onKeyUp: this.checkKeys, style: this.state.sectionStyle },
                    React.createElement("header", { style: headerStyle },
                        React.createElement(Typography_1.default, { gutterBottom: true, variant: "display1", color: "primary" }, "Select your desired subjects."),
                        React.createElement(TextField_1.default, { id: "searchbar", style: searchBoxStyle, onChange: this.handleSearchBoxOnChange, placeholder: "example: he/hubungan etnik/mpu3113", label: " Search . . ." })),
